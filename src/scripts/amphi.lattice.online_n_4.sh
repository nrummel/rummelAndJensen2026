...
#SBATCH --qos=mem
#SBATCH --job-name=amphi.lattice.online.n_4
#SBATCH --output=/projects/$USER/onlineResults/amphi.lattice.online.n_4.out
#SBATCH --error=/projects/$USER/onlineResults/amphi.lattice.online.n_4.err 
module purge
## Begin script
echo "=="
echo "||"
