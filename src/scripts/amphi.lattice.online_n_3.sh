...
#SBATCH --qos=mem
#SBATCH --job-name=amphi.lattice.online.n_3
#SBATCH --output=/projects/$USER/onlineResults/amphi.lattice.online.n_3.out
#SBATCH --error=/projects/$USER/onlineResults/amphi.lattice.online.n_3.err 
module purge
## Begin script
echo "=="
echo "||"
