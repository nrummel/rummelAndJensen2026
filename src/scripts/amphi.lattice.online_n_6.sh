...
#SBATCH --qos=mem
#SBATCH --job-name=amphi.lattice.online_n_6
#SBATCH --output=/projects/$USER/onlineResults/amphi.lattice.online_n_6.out
#SBATCH --error=/projects/$USER/onlineResults/amphi.lattice.online_n_6.err 
module purge
## Begin script
echo "=="
echo "||"
